        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              return _context.abrupt("return", successResponse(res, 200, "New attendee added successfully", _db.attendees));
      ...
      return _index["default"].async(function getAttendees$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _db.attendees.length > 0 ? successResponse(res, 200, "Attendees Record", _db.attendees) : errorResponse(res, 404, "No attendees found");
              _context3.next = 7;
              break;
