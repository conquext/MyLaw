...
function () {
  ...
  (0, _createClass2["default"])(TalkController, null, [{
    ...
    value: function addTalk(req, res) {
      ...
      return _regenerator["default"].async(function addTalk$(_context) {
        while (1) {
    ...
    value: function getTalk(req, res) {
      ...
      return _regenerator["default"].async(function getTalk$(_context2) {
        while (1) {
    ...
    value: function getAllTalks(req, res) {
      var talksFound;
      return _regenerator["default"].async(function getAllTalks$(_context3) {
        while (1) {
    ...
    value: function updateTalk(req, res) {
      ...
      return _regenerator["default"].async(function updateTalk$(_context4) {
        while (1) {
    ...
    value: function removeTalk(req, res) {
      ...
      return _regenerator["default"].async(function removeTalk$(_context5) {
        while (1) {
